...
describe('Observe.legacy', () => {
  ...
  it('One computed function attached to multiple reactive objects', () => {
  ...
  it('Computed functions can depend on multiple properties of a reactive object', () => {
  ...
  it('Observe is recursive and will make subobjects reactive', () => {
  ...
  it('Setting an object onto a reactive property makes the object reactive', () => {
  ...
  it('Setting an object onto a reactive property makes the entire object tree reactive', () => {
  ...
  it('Multiple (implicitly) reactive objects with one computed function using iterators', () => {
  ...
  it('Ignored objects are still valid and can be used in reactive properties', () => {
  ...
  it('Ignore can be used to replace objects in reactive properties without leaking', () => {
  ...
  it('Ignored objects are not reactive', () => {
  ...
  it('Computed functions will notify eachother continuously', () => {
  ...
  it('Nested computed functions do not share dependencies', () => {
  ...
  it('Dispose removes all the dependencies from a computed function', () => {
  ...
  it('Dispose disposes and returns its first argument', () => {
  ...
  it('Disposed functions cannot be manually notified', () => {
  ...
  it('Dispose called without an argument uses the current computed function', () => {
  ...
  it('Dispose usage in both clean and default mode', () => {
...
describe('Causing problems:', () => {
  ...
  it('Observe fails if passed a non-object (not including arrays) value', () => {
    nonObjects.forEach(val => assert.throws(() => observe(val)));
  });

  it('Ignore fails if passed a non-object (not including arrays) value', () => {
    nonObjects.forEach(val => assert.throws(() => ignore(val)));
  });

  it('Computed fails if passed a non-callable value', () => {
  ...
  it('Dispose fails if passed a non-callable value', () => {
    nonFunctions.forEach(val => assert.throws(() => dispose(val)));
  });

  it('Dispose fails if passed no arguments while no computed function is executing', () => {
...
describe('Edge cases', () => {
  ...
  it('Observe does not reactify prototypes', () => {
  ...
  it('Prototypes can be observed but their children will not be made reactive', () => {
  ...
  it('Properties that share names with Object.prototype properties work as expected', () => {
  ...
  it('Nonconfigurable properties will not be made reactive', () => {
  ...
  it('Nonenumerable properties will not be made reactive', () => {
    const object = observe(Object.defineProperty({}, 'val', {
      configurable: true,
      enumerable: false,
      writable: true,
  ...
  it('Nonwritable but enumerable and configurable properties will be overwritten and made writable', () => {
    const object = observe(Object.defineProperty({}, 'val', {
      configurable: true,
      enumerable: true,
      writable: false,
  ...
  it('Enumerable and configurable properties will remain enumerable and configurable', () => {
    const oldDescriptor = {
      configurable: true,
      enumerable: true,
      writable: false,
  ...
  it('No new enumerable properties are added', () => {
  ...
  it('Getter/setter properties will be accessed then overwritten', () => {
    let accessCount = 0;
    const object = {
      get val() {
        accessCount++;
  ...
  it('Properties named __proto__ will not be made reactive', () => {
  ...
  it('Computed does not leak `computedQueue` in the `this` value', () => {
    let thisValue;
    computed(function() {
